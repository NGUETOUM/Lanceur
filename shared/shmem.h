...
class GhostShmem {
 public:
  ...
  GhostShmem(int64_t client_version, const char* name, size_t size, int fd);
  GhostShmem(int64_t client_version, const char* name, size_t size);
  ~GhostShmem();

  // Connects to the region identified by "name", hosted by the process "pid".
  // REQUIRES: "pid" hosting "name" must exist.
  int Attach(int64_t client_version, const char* name, pid_t pid);
  int Attach(int64_t client_version, const char* name, pid_t pid, int fd);
  /*int Attach(int64_t client_version, const char* name, pid_t pid, int fd, uint32_t sched_items, uint32_t work_classes,
  ...
  static GhostShmem* GetShmemBlob(size_t size, int fd);
 ...
 private:
  ...
  void CreateShmem(int64_t client_version, const char* suffix, size_t size, int fd);
  //void CreateShmem(int64_t client_version, const char* suffix, size_t size, pid_t remote, int fd);
  int ConnectShmem(int64_t client_version, const char* suffix, pid_t pid);
  int ConnectShmem(int64_t client_version, const char* suffix, pid_t pid, int fd);
  //int ConnectShmem(int64_t client_version, const char* suffix, pid_t pid, int fd);
  /*int ConnectShmem(int64_t client_version, const char* suffix, pid_t pid, int fd, uint32_t sched_items, uint32_t work_classes,
                                                         uint32_t stream_capacity);*/
  ...
  static int OpenGhostShmemFd(const char* suffix, pid_t pid, int fd);
